...
# GUI 
# title
titleLabel = tk.Label(app, text=f"System Health Report {thermometer}", font=("Comic Sans MS", 28))
titleLabel.pack()
...
cpuLabel.pack()
memoryLabel = tk.Label(app, text="Memory usage: \n", font=("Helvetica", 14))
memoryLabel.pack()
cpuAndMemoryBtn = ttk.Button(app, text="Check CPU and Memory usage", command=CheckCPUandRAM, style="TButton")
...
# GUI
# Footer
footerLabel = tk.Label(app, text="Version 1 | Collin Dapper", font=("Comic Sans MS", 10))
